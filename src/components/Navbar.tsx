    ...
    <header className="no-print bg-slate-900/80 backdrop-blur-md border-b border-slate-800 sticky top-0 z-50 px-4 py-3 flex flex-wrap items-center justify-between gap-4">
      ...
      <div className="flex flex-wrap items-center gap-2 sm:gap-3 shrink-0">
        ...
        {activeResume && (
          <div className="flex items-center gap-1 bg-slate-950 p-1 rounded-xl border border-slate-800 shrink-0">
            <select 
              ...
              className="bg-transparent text-xs font-semibold text-slate-200 outline-none px-2 py-1 pr-6 cursor-pointer max-w-[100px] sm:max-w-none"
            >
              {resumes.map(r => (
            ...
            <button 
              ...
              className="p-1 hover:bg-slate-800 rounded-md text-slate-400 hover:text-indigo-400 transition-colors hidden sm:inline-flex"
            ...
            <button 
              ...
              className="p-1 hover:bg-slate-800 rounded-md text-slate-400 hover:text-slate-200 transition-colors hidden sm:inline-flex"
            ...
            <button 
              ...
              className="p-1 hover:bg-slate-800 rounded-md text-slate-400 hover:text-red-400 transition-colors hidden sm:inline-flex"
        ...
        <button
          ...
          className={`flex items-center gap-1.5 px-2.5 py-1.5 sm:px-3 sm:py-1.5 rounded-xl text-xs font-bold transition-all shrink-0 ${
            isUnlocked 
        ...
        >
          {isUnlocked ? (
            ...
            <>
              <Lock size={13} />
              <span className="hidden sm:inline">Unlock / Redeem</span>
            </>
          )}
        </button>
        ...
        <a
          ...
          className="flex items-center gap-1.5 px-2.5 py-1.5 sm:px-3 sm:py-1.5 rounded-xl text-xs font-bold bg-emerald-600/10 hover:bg-emerald-600/20 text-emerald-400 border border-emerald-500/20 transition-all shrink-0"
